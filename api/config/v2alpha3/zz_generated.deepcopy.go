...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DefaultRequirement) DeepCopyInto(out *DefaultRequirement) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultRequirement.
func (in *DefaultRequirement) DeepCopy() *DefaultRequirement {
	if in == nil {
		return nil
	}
	out := new(DefaultRequirement)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OPAControlPlaneConfig) DeepCopyInto(out *OPAControlPlaneConfig) {
	*out = *in
	...
	if in.DefaultRequirements != nil {
		...
		*out = make([]DefaultRequirement, len(*in))
		copy(*out, *in)
	}
