...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSObjectStorage) DeepCopyInto(out *AWSObjectStorage) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSObjectStorage.
func (in *AWSObjectStorage) DeepCopy() *AWSObjectStorage {
	if in == nil {
		return nil
	}
	out := new(AWSObjectStorage)
	in.DeepCopyInto(out)
	return out
}
