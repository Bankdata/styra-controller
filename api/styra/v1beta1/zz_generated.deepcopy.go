...
func (in *SystemSpec) DeepCopyInto(out *SystemSpec) {
	*out = *in
	...
	if in.DiscoveryOverrides != nil {
		in, out := &in.DiscoveryOverrides, &out.DiscoveryOverrides
		*out = new(DiscoveryOverrides)
		(*in).DeepCopyInto(*out)
	}
